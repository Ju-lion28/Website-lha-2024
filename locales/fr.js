...
const fr = {
	...
	journal: {
		Kiosk: {
			dec: "Après avoir reconstruit le kiosque, nous avons commencé à dessiner. Nous en avons réalisé la moitié avant la pause. Nous avons également planifié les couleurs à utiliser.",
			jan: "Nous avons terminé l'esquisse au cours de ce mois. Cependant, nous n'avons pas pu commencer à peindre immédiatement car nous manquions de peinture. Finalement, nous avons peint la terre rose et la base du ciel.",
			feb: "En février, nous avons peint des montagnes et des lacs en chocolat et y avons ajouté des détails complexes."
		},
		Media: {
			aug: "En août, nous avons écrit le scénario de la vidéo. Le scénario a été revu et réécrit plusieurs fois avec différentes intrigues pour voir ce qui fonctionnerait le mieux dans le canon de l'histoire originale de Wreck-It-Ralph. L'avancement du projet a été retardé jusqu'à ce que nous trouvions un costume pour George.",
			jan: "En janvier, nous avons reçu les costumes.",
			feb: "Le tournage s'est déroulé sans encombre. Lundi, Samir, George et Uzma ont commencé à filmer la deuxième partie du film, Uzma ayant dû partir pour le Bangladesh. Nous nous sommes beaucoup amusés à filmer cette partie du film. Nous avons dû faire beaucoup de reprises parce que nous riions beaucoup et que des gens de l'école nous interrompaient. Au cours de la dernière semaine de février, Samir et George sont allés filmer dans différents endroits de Montréal. Nous sommes allés à l'Oratoire Saint-Joseph du Mont-Royal, à l'extrémité de l'île de Montréal et nous avons filmé sur l'eau. Nous avons pris beaucoup de photos différentes qui donneront un aspect cool à la vidéo. Nous avons imprimé en 3D des accessoires pour le film et nous avons commencé à filmer les dernières parties du film et le montage a commencé.",
			mar: "En mars, l'équipe a terminé la vidéo. Nous avons dû monter la vidéo et éditer les séquences dont nous disposions pour que le tout soit cohérent. Nous avons également réalisé les dernières prises de vue de notre personnage principal, Ralph, joué par George, travaillant sur notre robot. C'était en fait un véritable défi, avec la date butoir qui se profilait à l'horizon."
		},
		months: {
			jan: "Janvier",
			feb: "Février",
