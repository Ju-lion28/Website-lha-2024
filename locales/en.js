const en = {
	...
	journal: {
		...
		Robot: {
			...
			oct: "We decided to use last year’s base for the robot. Since this is our second year, knowing what we know now, we were able to make the right changes quicker and we knew what to prioritize and what to discard.",
	...
	game: {
		...
		game4:  "This year’s competition is called Kryptik. It will be held at Curé-Antoine-Labelle H.S. 216 Boul Marc-Aurèle-Fortin, Laval, QC, H7L 1Z5 from April 11th to the 13th.",
		...
		game8:  "There will be one tall target on the back of each side and one short target on the side with each team’s color. The goal is to get the game pieces into the targets or on the multiplayer and get as many points as possible for your team.",
